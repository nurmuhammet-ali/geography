    ...
    <section class="game">
        <div class="container">
            <div class="flag-game">
                ...
                <template v-if="!finished">
                    <div class="content">
                        <h2 class="red-text text-lighten-1">Baýdak oýny</h2>
    ...
    export default {
        ...
        methods: {
            ...
            giveAnswer(answer, event) {
                ...
                if (this.questions[this.currentQuestion-1].name == answer) {
                    this.trueAnswers += 1;
            ...
            setQuestions() {
                ...
                this.answers.push(this.questions[this.currentQuestion-1].name);
                let rand = Math.floor(Math.random()*this.answers.length);
                let replace = this.answers[rand];
                this.answers[rand] = this.questions[this.currentQuestion-1].name;
                this.answers[3] = replace;
            },
            getQuestions() {
                axios.post('/api/flag/questions')
                    .then(response => {
